        ...
        (function () {
            ...
            try {
                ...
                window.addEventListener("DOMContentLoaded", function () {
                    ...
                    bar.innerHTML = '<div style="max-width:420px"><p style="font-size:1rem;margin:0 0 1rem">This page is embedded and can’t complete authorization here.</p>' +
                        '<a href="' + url + '" target="_top" rel="noopener" style="display:inline-block;padding:.7rem 1.1rem;border-radius:10px;background:#2563eb;color:#fff;text-decoration:none;font-weight:600">Open Bitcost in your browser ↗</a>' +
